...
class EvaluateModel:
    ...
    def __init__(self):
        ...
        self.historic_path = os.path.join(self.base_path, self.data_dir, f"X_V200_P1.pkl")
        self.next_path = os.path.join(self.base_path, self.data_dir, f"y_V200_P1.pkl")
    ...
    def get_similar_embeddings_to_disk(self, predicted_embeddings):
        qadrant_api = QadrantAPI()

        # Perform similarity search
        similar_vectors = qadrant_api.perform_similarity_search(predicted_embeddings)
    ...
    @staticmethod
    def sequential_search(product_lists, total_limit=10):
        #pdb.set_trace()
...
def main():
    ...
    if args.query:
        ...
        similar_vectors = evaluator.get_similar_embeddings_to_disk(predicted_embeddings) # , customers, products_lists, target_embeddings)
